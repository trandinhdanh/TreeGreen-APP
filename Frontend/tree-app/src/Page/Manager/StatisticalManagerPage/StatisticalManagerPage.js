...
<AreaChart width={900} height={400} data={statiscal}
  ...
  <Tooltip />
  <Area type="monotone" dataKey="reallyReceived" stroke="#8884d8" fillOpacity={1} fill="url(#colorUv)" />
  <Area type="monotone" dataKey="totalRevenue" stroke="#82ca9d" fillOpacity={1} fill="url(#colorPv)" />
</AreaChart>
