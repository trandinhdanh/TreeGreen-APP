...
export default function ShopPage() {
  ...
  return (
    ...
    <button onClick={() => { handleIsFilter() }} className=' lg:hidden flex items-center text-[12px] mt-24 mx-auto text-white  bg-primary font-medium rounded-lg text-sm px-4 py-2 '><BiFilterAlt/>Filler</button>
      <div className='grid grid-cols-4 gap-10 container mx-auto mb:px-5 md:px-24 lg:px-24 pt-10'>
        <div className={`${isFilter ? 'fixed top-0 left-0 bottom-0 p-5 z-30 bg-white md:block sm:block mb:block w-[300px]' : 'md:  sm:hidden mb:hidden'} lg:col-span-1 lg:block animate__fadeInLeft animate__animated`}>
